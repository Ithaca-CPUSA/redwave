<template>
    <div
        class="mb-2 text-gray-600 flex items-center content-center flex-1 justify-end">
        <h2 class="sr-only">Social menu</h2>
        <ul class="flex justify-end items-center content-center">
            <li class="mx-2">
                <a href="">
                    <svg class="h-4 w-4 fill-current" role="img"
